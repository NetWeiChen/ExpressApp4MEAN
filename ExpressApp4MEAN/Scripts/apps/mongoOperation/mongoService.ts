...
export function fetch(request, response) {
...
export function addNewMovie(request, response) {
...
export function updateSpecificMovie(request, response) {
...
export function getSpecificMovie(request, response) {
