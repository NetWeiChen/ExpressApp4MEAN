...
if (undefined != process.env['NODE_ENV']) {
    ...
    // Dynatrace code
    //var dynatraceEnv = appEnv.getServiceCreds("xxxxx");
    //var dynatraceServer = dynatraceEnv.server;
    //var dynatraceAgent = dynatraceEnv.agentName;

    //try {
    //    require('./dynatrace-6.3/agent/nodejs/nodejsagent.js')({ server: dynatraceServer, agentName: dynatraceAgent });
    //}
...
import mongoModule = require('./Scripts/apps/mongoOperation/MongoService');
app.use(bodyParser());
